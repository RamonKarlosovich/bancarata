      ...
      <nav className="border-b border-[#D4AF37]/20 py-4 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-6 flex justify-between items-center">
          <div className="flex-shrink-0 -ml-8 w-24 h-20 overflow-hidden rounded-full opacity-95">
            <Image src="/logo.png" alt="INVERATBANK" width={120} height={120} className="mix-blend-screen" />
          </div>

          <div className="absolute left-1/2 transform -translate-x-1/2">
            <span className="text-[#D4AF37] font-bold text-2xl">INVERATBANK</span>
          </div>
            ...
            <div className="bg-[#0F1B2E]/50 backdrop-blur border border-[#D4AF37]/30 rounded-lg p-8">
              ...
              <div className="mt-6 p-4 rounded-lg bg-[#D4AF37]/10 border border-[#D4AF37]/20">
                <p className="text-xs text-[#F5F1E8]/70">
                  ✓ Tus datos están protegidos con encriptación SSL de nivel bancario. ✓ Transacción segura y verificada por INVERATBANK.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-3 gap-8 mb-8">
            <div className="text-center">
              <h4 className="text-[#D4AF37] font-bold mb-2">INVERATBANK</h4>
            ...
            <div className="text-center">
              ...
              <p className="text-[#F5F1E8]/70 text-sm">dalekmiaw@inveratbank.com</p>
            ...
            <div className="text-center">
              ...
              <p className="text-[#F5F1E8]/50 text-xs mt-1">SWIFT: INVERATBANKMX</p>
            </div>
          </div>

          <div className="border-t border-[#D4AF37]/20 pt-6">
            <div className="text-center text-[#F5F1E8]/70 mb-4">
              <p className="text-sm font-semibold mb-2">INVERATBANK © 2025 - Global Financial Trust</p>
