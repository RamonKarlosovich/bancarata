      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-6 text-[#F5F1E8]/70">
          ...
          <section>
            ...
            <p>
              INVERATBANK se reserva el derecho de validar toda la información proporcionada. El proceso de aprobación puede tomar hasta 48 horas hábiles. Nos comunicaremos contigo a través del correo electrónico o teléfono proporcionado.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              INVERATBANK puede rechazar una solicitud si identifica información incompleta, fraudulenta o si no cumple con los requisitos regulatorios. En caso de rechazo, se notificará al solicitante con los motivos.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              INVERATBANK puede cobrar comisiones por servicios prestados según lo establecido en el tarificador vigente. Cualquier cambio en comisiones será notificado con anticipación.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Tus datos personales serán tratados de conformidad con la Ley Federal de Protección de Datos Personales. INVERATBANK se compromete a mantener la confidencialidad de tu información.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              INVERATBANK se reserva el derecho de cerrar una cuenta si se detecta fraude, uso indebido o incumplimiento de estos términos. Se notificará al usuario con anticipación cuando sea posible.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              INVERATBANK puede modificar estos términos en cualquier momento. Los cambios serán comunicados a través de correo electrónico o disponibles en nuestro sitio web.
            </p>
          </section>

          <div className="bg-[#D4AF37]/10 border border-[#D4AF37]/20 rounded-lg p-6 mt-8">
            <p className="text-[#F5F1E8]">
              Al solicitar una cuenta en INVERATBANK, confirmas que has leído, entendido y aceptas estos términos y condiciones.
            </p>
          </div>
